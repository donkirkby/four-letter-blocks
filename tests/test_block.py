...
def test_draw_with_tabs(pixmap_differ: PixmapDiffer):
    ...
    with pixmap_differ.create_painters(400, 260) as (actual, expected):
        ...
        path.lineTo(-37.5, 0)
        path.cubicTo(-25.0, 0, -28.75, -1.65, -17.963, -1.65)
        path.cubicTo(-11.5, -1.65, -10.12, 0, -11.5, 3.3)
        path.cubicTo(-12.88, 6.6, -14.28, 9.9, -15.3, 11.55)
        path.cubicTo(-13.6, 13.2, -13.6, 16.5, 0, 16.5)
        path.cubicTo(13.6, 16.5, 13.6, 13.2, 15.3, 11.55)
        path.cubicTo(14.28, 9.9, 12.88, 6.6, 11.5, 3.3)
        path.cubicTo(10.12, 0, 11.5, -1.65, 17.963, -1.65)
        path.cubicTo(28.75, -1.65, 25, 0, 37.5, 0)
        path.lineTo(50, 0)
